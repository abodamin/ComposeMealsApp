package com.abdullah.composeapp.domain.models

import javax.inject.Inject

class CategoriesListUseCase @Inject constructor() {

    operator fun invoke(): MutableList<Category>{
        return createSampleCategoryList()
    }

    private fun createSampleCategoryList(): MutableList<Category> {
